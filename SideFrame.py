...
class SideFrame(ctk.CTkFrame):
    ...
    def __init__(self, master, width, fgcolor):
        ...
        btn_graph = ctk.CTkButton(master=sideFrame, image=skale_img, text="", width=80, height=60, compound="right", fg_color=cp.blue, cursor="tcross", command=set_value_select(0))
        ...
        btn_temp = ctk.CTkButton(master=sideFrame, image=temp_img, text="", width=80, height=60, compound="right", fg_color=cp.blue, cursor="tcross", command=set_value_select(1))
        ...
        btn_pressure = ctk.CTkButton(master=sideFrame, image=pres_img, text="", width=80, height=60, compound="right", fg_color=cp.blue, cursor="tcross", command=set_value_select(2))
        ...
        btn_humidity = ctk.CTkButton(master=sideFrame, image=hum_img, text="", width=80, height=60, compound="right", fg_color=cp.blue, cursor="tcross", command=set_value_select(3))
        ...
        btn_list = ctk.CTkButton(master=sideFrame, image=list_img, text="", width=80, height=60, compound="right", fg_color=cp.blue, cursor="tcross", command=set_value_select(4))
        ...
        btn_profile = ctk.CTkButton(master=sideFrame, image=pro_img, text="", width=80, height=60, compound="right", fg_color=cp.blue, cursor="tcross")
        ...
        btn_settings = ctk.CTkButton(master=sideFrame, image=set_img, text="", width=80, height=60, compound="right", fg_color=cp.blue, cursor="tcross")
        ...
        btn_news = ctk.CTkButton(master=sideFrame, image=news_img, text="", width=80, height=60, compound="right", fg_color=cp.blue, cursor="tcross")
